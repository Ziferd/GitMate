...
banner() {
    echo ""
    [ "$GITMATE_LANG" = "id" ] && echo "  ╔══════════════════════════════════════╗" || echo "  ╔══════════════════════════════════════╗"
    [ "$GITMATE_LANG" = "id" ] && echo "  ║         🛠️  GitMate v4.0             ║" || echo "  ║         🛠️  GitMate v4.0             ║"
    [ "$GITMATE_LANG" = "id" ] && echo "  ║   GitHub CLI Assistant for Termux    ║" || echo "  ║   GitHub CLI Assistant for Termux    ║"
    [ "$GITMATE_LANG" = "id" ] && echo "  ║      Developer By: Ziferd            ║" || echo "  ║      Developer By: Ziferd            ║"
    [ "$GITMATE_LANG" = "id" ] && echo "  ╚══════════════════════════════════════╝" || echo "  ╚══════════════════════════════════════╝"
    echo ""
}
...
cmd_help() {
    ...
    [ "$GITMATE_LANG" = "id" ] && echo "│  gitmate init    [nama_proyek]         buat repo baru dari nol │" || echo "│  gitmate init    [project_name]        create repo from scratch  │"
    ...
    [ "$GITMATE_LANG" = "id" ] && echo "│  gitmate reflog                       penyelamat HEAD nyasar   │" || echo "│  gitmate reflog                       HEAD recovery log          │"
    ...
    echo "├──────────────────────────────────────────────────────────────┤"
    [ "$GITMATE_LANG" = "id" ] && echo "│  Set GITMATE_LANG=id untuk Bahasa Indonesia                    │" || echo "│  Set GITMATE_LANG=en for English (default)                       │"
    [ "$GITMATE_LANG" = "id" ] && echo "│  Set WEBHOOK_URL untuk notifikasi (Slack/Discord/dll)          │" || echo "│  Set WEBHOOK_URL for notifications (Slack/Discord/etc)           │"
    echo "└──────────────────────────────────────────────────────────────┘"
    echo ""
}
